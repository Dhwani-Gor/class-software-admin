                    ...
                    <Box>
                      {isCheckbox ? (
                        ...
                        <Grid2 size={{ xs: 12 }} key={attr}>
                          ...
                          <TextareaAutosize style={{ width: "100%" }} minRows={4} multiline label={field.label || formatLabel(attr)} value={formData[attr] || ""} onChange={(e) => handleInputChange(attr, e.target.value)} placeholder={field.label} />
                        </Grid2>
                      ) : isRadioWithStrike ? (
                        (() => {
