...
import { getAllSystemVariables, getSpecificClient, getSurveyReportData, uploadSurveyReport } from "../api";
...
const SurveyReport = ({ id }) => {
 ...
 <table class="three-columns-table" style="width: 100%; border: 1px dotted gray;">
    <tr style="border: 1px dotted gray;">
      ...
      <td style="border: 1px dotted gray;">${clientData?.shipName || '[shipName]'}</td>
    ...
    <tr style="border: 1px dotted gray;">
      ...
      <td style="border: 1px dotted gray;">${clientData && moment(clientData?.dateOfBuild).format('DD/MM/YYYY') || '[buildDate]'}</td>
      <td class="label" style="border: 1px dotted gray;"><strong>Ship Type:</strong></td>
      <td style="border: 1px dotted gray;">${clientData?.typeOfShip || '[shipType]'}</td>
      <td class="label" style="border: 1px dotted gray;"><strong>Flag:</strong></td>
      <td style="border: 1px dotted gray;">${clientData?.flag || '[flag]'}</td>
    </tr>
    <tr style="border: 1px dotted gray;">
      <td style="border: 1px dotted gray;"><strong>IMO Number:</strong></td>
      <td style="border: 1px dotted gray;">${clientData?.imoNumber || '[imoNumber]'}</td>
      ...
      <td style="border: 1px dotted gray;">${uniquePorts || '[portOfSurvey]'}</td>
    </tr>
    <tr style="border: 1px dotted gray;">
      <td style="border: 1px dotted gray;"><strong>Port of Registry:</strong></td>
      <td style="border: 1px dotted gray;">${clientData?.portOfRegistry || '[port]'}</td>
