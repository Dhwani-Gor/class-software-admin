...
const Certificates = () => {
  ...
  return (
    <Layout>
      ...
      <ShowAmdRemarksDialog open={openAmdRemarks} onClose={() => setOpenAmdRemarks(false)} reportDetailId={selectedReportId} selectedFilter={selectedFilter} hasArchivePermission={hasArchivePermission} />
    </Layout>
  );
};
